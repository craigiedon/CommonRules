...
def run():
    ...
    start_time = 0.0
    end_time = 8.0
    res = car_mpc(start_time, end_time, start_state, task_config, [], [], CostWeights(x_prog=0.0001, y_prog=1.0, v_track=20, acc=500, ang_v=1, jerk=0, road_align=1, lane_align=5))
